...
fn try_parse_collection_burn_successful(){
    new_test_ext().execute_with(|| {
        ...
        System::assert_has_event(RuntimeEvent::Uniques(pallet_uniques::Event::Destroyed { collection: 0 }));
    });
}
...
fn try_parse_collection_metadata_successful() {
    new_test_ext().execute_with(|| {
        ...
        System::assert_has_event(RuntimeEvent::Uniques(pallet_uniques::Event::CollectionMetadataSet { collection: 0, data: BoundedVec::new(), is_frozen: false }));
    });
}
...
fn try_parse_collection_owner_successful() {
    new_test_ext().execute_with(|| {
        ...
        System::assert_has_event(RuntimeEvent::Uniques(pallet_uniques::Event::OwnerChanged { collection: 0, new_owner: BOB }));
    });
}
...
fn try_parse_nft_burn_successful() {
    new_test_ext().execute_with(|| {
        ...
        System::assert_has_event(RuntimeEvent::Uniques(pallet_uniques::Event::Burned { collection: 0, item: 0, owner: ALICE }));
    });
}
...
fn try_parse_nft_metadata_successful() {
    new_test_ext().execute_with(|| {
        ...
        System::assert_has_event(RuntimeEvent::Uniques(pallet_uniques::Event::MetadataSet { collection: 0, item: 0, data: BoundedVec::new(), is_frozen: false }));
    });
}
...
fn try_parse_nft_owner_successful() {
    new_test_ext().execute_with(|| {
        ...
        System::assert_has_event(RuntimeEvent::Uniques(pallet_uniques::Event::Transferred { collection: 0, item: 0, from: ALICE, to: BOB }));
    });
}
...
fn parse_collection_same_owner_successful(){
    new_test_ext().execute_with(|| {
        ...
        let _ = XcNFT::parse_collection_same_owner(RuntimeOrigin::signed(ALICE), None, BoundedVec::new(), nfts.clone(), 1000.into(), 0, None);
...
fn parse_collection_diff_nft_owners_successful(){
    new_test_ext().execute_with(|| {
        ...
        let _ = XcNFT::parse_collection_diff_owners(RuntimeOrigin::signed(ALICE), None, BoundedVec::new(), nfts.clone(), 1000.into(), 0, None);
