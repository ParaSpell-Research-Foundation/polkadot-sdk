...
fn try_mint_collection_transfer_xcm_fail() {
	new_test_ext().execute_with(|| {
		...
		let _ = XcnftModule::deposit_token(RuntimeOrigin::root(), 1, 1000);

		let _ = XcnftModule::mint_collection_xtransfer(
...
fn try_mint_collection_transfer_collection_exists_fail() {
	new_test_ext().execute_with(|| {
		...
		let _ = XcnftModule::mint_collection(
			RuntimeOrigin::signed(1),
			b"Collection".to_vec().try_into().unwrap(),
			b"Description".to_vec().try_into().unwrap(),
		);
		...
		assert_noop!(
			XcnftModule::mint_collection_xtransfer(
				RuntimeOrigin::signed(1),
				b"Collection".to_vec().try_into().unwrap(),
				b"Description".to_vec().try_into().unwrap(),
				2000.into(),
...
fn try_receive_existing_collection() {
	new_test_ext().execute_with(|| {
		...
		let _ = XcnftModule::mint_collection_received(
			RuntimeOrigin::signed(1),
			b"Collection".to_vec().try_into().unwrap(),
			b"Description".to_vec().try_into().unwrap(),
			1000.into(),
...
fn try_collection_transfer_xcm_fail() {
	new_test_ext().execute_with(|| {
		...
		let _ = XcnftModule::collection_xtransfer(
			RuntimeOrigin::signed(1),
			collection_hash,
			2000.into(),
			1,
...
fn try_collection_transfer_non_existing_collection() {
	new_test_ext().execute_with(|| {
		...
		//Try creating new collection
		assert_noop!(
			XcnftModule::collection_xtransfer(
				RuntimeOrigin::signed(1),
				H256::zero(),
				2000.into(),
				1,
...
fn mint_nft_xtransfer_collection_not_existing() {
	new_test_ext().execute_with(|| {
		...
		assert_noop!(
			XcnftModule::mint_non_fungible_xtransfer(
				RuntimeOrigin::signed(1),
...
fn mint_non_fungible_collection_full() {
	new_test_ext().execute_with(|| {
		...
		for i in 0..255 {
			...
			let _ = XcnftModule::mint_non_fungible(
				RuntimeOrigin::signed(1),
				b"NFT".to_vec().try_into().unwrap(),
...
fn mint_non_fungible_received_to_non_existing_collection() {
	new_test_ext().execute_with(|| {
		...
		let _ = XcnftModule::deposit_token(RuntimeOrigin::root(), 1, 1000);
		let _ = XcnftModule::deposit_token(RuntimeOrigin::root(), 1, 2000);
		...
		let _ = XcnftModule::mint_non_fungible_received(
			RuntimeOrigin::signed(1),
			b"NFT".to_vec().try_into().unwrap(),
			b"Description".to_vec().try_into().unwrap(),
			collection_hash,
...
fn non_fungible_xtransfer_not_existing_nft() {
	new_test_ext().execute_with(|| {
		...
		assert_noop!(
			XcnftModule::non_fungible_xtransfer(
				RuntimeOrigin::signed(1),
				H256::zero(),
				2000.into(),
				1000.into(),
